...
async def finish_analysis(callback: CallbackQuery):
    ...
    ✨ А если захочется лучше понять уже не отношения, а себя — в Life Guide 👆 можно разобрать свою дату рождения и увидеть свои сильные стороны, внутренние особенности и жизненное направление."""
    )
